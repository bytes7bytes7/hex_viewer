...
if __name__ == '__main__':
	...
	if '-h' in args or 	len(args)==0:
		print('''
			...
			\r\t-c\tУказание количества симолов в строке\n\t\t\tПример: -c 1\n
			\r\t-b\tУказание отображения в битах. По умолчанию в байтах\n\t\t\tПример: -b\n
			\r\t-B\tУказание отображения в байтах. По умолчанию в байтах\n\t\t\tПример: -B\n
			\r\t-d\tУказание отображения в десятичных числах. По умолчанию в байтах\n\t\t\tПример: -d\n
			''')
	else:
		run(args)